  ...
  return (
    <Reveal>
      <section>
        ...
        <div className="no-scrollbar flex gap-3 overflow-x-auto overscroll-x-contain px-6 pb-2 md:px-12">
          {top.map((m, i) => (
            <motion.div
              key={m.id}
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 w-32 rounded-2xl bg-white/5 p-1.5 ring-1 ring-white/10 transition-transform duration-500 ease-fluid group-hover:-translate-y-2 md:w-40">
                  <div className="aspect-2/3 overflow-hidden rounded-[0.875rem] bg-onyx">
                    <img
